...
const defaultMiniappApiBaseUrl = 'https://localleads.haitunai.cn'
const defaultMiniappAppCode = 'trade-leads-miniapp'
...
const businessMiniappModules = [
  ...
  {
    name: 'forest-user-lead',
    sourceRoot: path.resolve(projectRoot, '../../../../business/aggregations/user-lead/frontend/src/wechat-miniapp')
  },
  {
    name: 'forest-point',
    sourceRoot: path.resolve(projectRoot, '../../../../business/domains/point/frontend/src/wechat-miniapp')
  },
  {
    name: 'forest-recharge',
    sourceRoot: path.resolve(projectRoot, '../../../../business/domains/recharge/frontend/src/wechat-miniapp')
  }
].map((item) => ({
  ...item,
...
function findReusableMiniappEntries(directory) {
  ...
  return walk(directory).filter((file) => {
    ...
    return isMiniappComponentDirectory(runtimeDir)
  })
}
...
function watchDirectories() {
  const candidates = [
    ...
    path.resolve(projectRoot, '../../../../business/domains/payment/frontend/src')
  ]
